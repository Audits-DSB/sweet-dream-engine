    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          />
          <h1 className="text-xl font-bold text-foreground">{t.welcomeTo} DSB</h1>
          <p className="text-muted-foreground mt-1">{t.signInToAccount}</p>
        </div>
        ...
        <div className="stat-card p-6 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-card px-2 text-muted-foreground">{t.orContinueWithEmail}</span></div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} className="ps-10 pe-10 h-11" required />
          ...
          <p className="text-center text-sm text-muted-foreground">
            {t.dontHaveAccount} <Link to="/signup" className="text-primary hover:underline font-medium">{t.signUpLink}</Link>
          </p>
        </div>
      </div>
    </div>
